...
contract Staker is RrpRequesterV0 {
    ...
    mapping(bytes32 => uint256) public requestIdWinningNumber;
    ...
    function fulfillUint256(
        ...
        requestIdWinningNumber[requestId] = qrngUint256;
        roulette.executeResult(qrngUint256);
    ...
    function setRoulette(Roulette _roulette) public {
